...
public class EmployeeController {
	...
	public ModelAndView editEmployee(@RequestParam Long id) throws InvalidEmployeeIdException {
	...
	public ModelAndView deleteEmployee(@RequestParam Long id) throws InvalidEmployeeIdException {
